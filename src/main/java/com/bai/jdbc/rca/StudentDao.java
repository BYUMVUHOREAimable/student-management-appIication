...
public class StudentDao {
	...
	private static final String INSERT_STUDENT_SQL = "INSERT INTO studentmanagementdb.student (name, age, dob, school, code, email, mobile) VALUES (?, ?, ?, ?, ?, ?, ?);";
	...
	private void createStudentTableIfNotExists(Connection connection) {
		String createTableSQL = "CREATE TABLE IF NOT EXISTS studentmanagementdb.student (" +
